...
from tools import EOF, padRatio_to_pixels
from create_procs import get_nkerns, get_target_dim
from tools import (get_bound_mask, mask_padded_kpts,
...
def create_TCDCN_obejct(pkl_param_file, dset='MTFL', create_object=True):
    ...
    if paral_conv:
        ...
        if paral_conv == 5:
            from RCN_300W import TCDCN_ConvNet
