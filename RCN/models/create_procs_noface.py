...
import argparse
from tools import EOF
from tools import shuffleData, splitData, mergeData
from preprocess_noface import preprocess_iter, preprocess_once
from queue import OrderedQueue
...
def get_data(mask_MTFL, mask_300W, all_train, **kwargs):
    ...
    if mask_300W:
        ...
        Test['300W'] = (valid_300W_x, valid_300W_y)
...
def preprocess_data(sets, mask_MTFL, mask_300W, scale_mul,
    ...
    if mask_300W:
        ...
        Test['300W'] = (valid_set_x_300W, valid_set_y_300W)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dist_ratio', type=float, help='the multiplier of face_bounding box for jittering', default=1)
    ...
    parser.add_argument('--rotation', type=int, help='the max rotationation for preprocessing', default=0)
