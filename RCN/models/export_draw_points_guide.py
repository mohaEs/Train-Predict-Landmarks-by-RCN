...
from convnet_tools import create_TCDCN_obejct
...
#    imgs = pickle.load(fp)
  ...
  #  os.mkdir(outputfolder)
    ...
    Dict = { "pred_kpts": pred_kpts, "truth_kpts":truth_kpts}  
    pickle.dump( Dict, open( outputfolder+"keypoints_results.pickle", "wb" ),protocol=2 )
    ...
    for img, kpts, id in zip(imgs, pred_kpts, np.arange(n_bch)):
        ...
        name = outputfolder+'img_%s.png' % (id)
	#print(name)
