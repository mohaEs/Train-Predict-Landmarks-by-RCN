...
from affine_transform import transform_bbox
from polar_cartesian_convert import pol_to_cart, cart_to_pol
from tools import (shuffleData, splitData,
...
from detect_face import detect_dataset_faces
...
def preprocess_once(set_x, set_y, gray_scale=True, dist_ratio=3.8/4.0):
    ...
    rects = np.zeros((set_x.shape[0],4),dtype=np.uint8)
...
def preprocess_iter(set_x, set_y, seed_rng, target_dim=(80, 80), jitter=True,
                    ...
                    fixed_block=False, rotation=0, get_rotation=False,
                    rotation_set=None):
    """
